...
export default function ReviewPage() {
  ...
  return (
    <>
      <PageHeader title="Analyst Review" description="A human-in-the-loop validation queue for correcting risky or misleading AI analysis before it becomes a product decision artifact." />
