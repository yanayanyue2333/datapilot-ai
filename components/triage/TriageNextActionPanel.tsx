  ...
  return (
    <Card className="border-emerald-200 bg-emerald-50">
      <div className="grid gap-4 lg:grid-cols-[1fr_0.7fr]">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-emerald-700">Recommended follow-up</p>
          <h2 className="mt-2 text-xl font-semibold text-emerald-950">Likely cause hypothesis</h2>
          <p className="mt-3 text-sm leading-6 text-emerald-900">本周 GMV 下滑更可能来自自然流量质量下降叠加移动端支付转化下滑，而不是付费渠道预算变化。</p>
          <div className="mt-4 grid gap-3 md:grid-cols-2">
            <Info label="Recommended product action" value="优先排查首页推荐流量质量、搜索入口变化和移动端支付链路。" />
            <Info label="Data validation needed" value="确认活动日、库存异常和埋点口径是否影响自然流量转化。" />
            <Info label="Owner" value="Growth PM + Data Analyst" />
            <Info label="Priority" value="P1 this week" />
          </div>
        </div>
