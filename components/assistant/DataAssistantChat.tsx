      ...
      <section className="space-y-5">
        <Card className="bg-slate-950 text-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-semibold">DataPilot Assistant</h2>
              <p className="text-sm text-slate-300">Governed answers. Honest refusals. Analyst-ready trace.</p>
            </div>
          </div>
          <form className="mt-6" onSubmit={onSubmit}>
            <label className="text-sm font-medium text-slate-200" htmlFor="assistant-question">Ask a business data question</label>
            <textarea
        ...
        <Card>
          <h3 className="text-sm font-semibold text-slate-950">Suggested questions</h3>
        ...
        {submittedQuestion ? (
          <Card>
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-medium text-slate-500">User question</p>
        ...
        {isThinking ? (
          <Card>
            <div className="flex items-center gap-3 text-sm text-slate-600">
              ...
              Checking intent, Metric Registry definitions, and available governed signals...
            </div>
          </Card>
        ) : null}
